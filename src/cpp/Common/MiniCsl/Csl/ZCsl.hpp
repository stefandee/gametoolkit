 ...
 * 2001.11.11  Libraries went out                          Karg
 * 2001.12.02  Libraries went back in, modified form       Karg
 *
 * OPEN SOURCE LICENSE
 *
...
class ZCsl : public ZBase
{
      ...
      */
      ...
      ZCsl&
         addFunc(                        // add a function
            ...
            T* pType,
            ZString (T::*aFunc)(ZCsl* aCsl))  // C++ member function address
	  {
		  return addFunc(aFileName, aFuncHeader, ZCsl_callback_t(pType, aFunc));
	  }
      ...
      ZCsl&
         addFunc(                           // add a function
            const ZString& aFileName,       // file/module name for function
            const ZString& aFuncHeader,     // function header
            ZCsl_callback_t aFunc);         // C++ functor object
      ...
      ZCsl&
         addFunc(                        // add a function
            ...
            ZString (__closure *aFunc)(ZCsl* aCsl));  // function address
      */
   ...
   private:
      ...
      */
      ...
      class Function
      {
         public:
            ...
            Function(                             // constructor for native c++ function
                   ZCsl* aParent,                 // parent
                   const ZString& aName,          // function name
                   ZCsl_callback_t callback,  // member function callback object
                   Function* aPrev)               // previous function
            :  iName(aName),
               iPrev(aPrev),
               iCppFunc(callback),
            ...
            Function(                    // constructor for native c++ function
               ...
               const ZString& aName,        // function name
               ZCsl_callback_t callback,  // member function callback object
               // ZString (__closure *aFunc)(ZCsl* aCsl), // c++builder method address
               // ZString (*aFunc)(ZCsl* aCsl),// function address
               Function* aPrev);            // previous function
            */
            ...
            int /*Function::*/paramCnt();    // get parameter count
            ...
            ZCsl_callback_t iCppFunc;
            ZString         (*iFunc)(ZCsl* aCsl); // ptr to native C++ function
            //ZString        (__closure *iFunc)(ZCsl* aCsl); // ptr to native c++ function
      ...
      ZLibrary*      iLibs;              // list of loaded libraries's
