...
ZCsl::Library::Library(ZCsl* aParent, const ZString& aDllName, Library* aPrev) :
   ...
   iParent(aParent)
{
   ZFUNCTRACE_DEVELOP("ZCsl::Library::Library(ZCsl* aParent, const ZString& aDllName, Library* aPrev)");
   try {
...
void ZCsl::Library::initApi(ZBoolean& aFound)
{
   ...
   initialize = (void (ZFuncptrAPI)(ZCsl*))iDll->procAddress("ZCslInitLibAPI");
   aFound = zTrue;
...
void ZCsl::Library::cleanupApi(ZBoolean& aFound)
{
   ...
   cleanup = (void (ZFuncptrAPI)(ZCsl*))iDll->procAddress("ZCslCleanupLibAPI");
   aFound = zTrue;
