...
ZPointerlist::ZPointerlist(const ZPointerlist& aPointerlist) :
   iCount(0),
   iSize(0),
   iList(0)
{
...
ZPointerlist& ZPointerlist::operator=(const ZPointerlist& aList)
{
...
void* ZPointerlist::operator[](long aIndex) const
{
...
ZPointerlist& ZPointerlist::removeFromPos(long aIndex)
{
...
ZPointerlist& ZPointerlist::addAtPos(long aIndex, void* aPointer)
{
...
ZPointerlist& ZPointerlist::drop()
{
...
long ZPointerlist::find(const void* aPointer) const
{
