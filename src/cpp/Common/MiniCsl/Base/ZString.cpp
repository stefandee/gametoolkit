...
ZStringBuffer::ZStringBuffer(long aSize) :
   iRefCount(1),
   iLogSize(0),
   iPhySize(0),
   iData(iNulString)
...
ZStringBuffer::ZStringBuffer(ZStringBuffer& aBuffer) :
   iRefCount(1),
   iLogSize(0),
   iPhySize(0),
   iData(0)
...
void ZStringBuffer::setSize(long aSize)
{
...
ZString::ZString(const ZString& aString) :
...
ZString::ZString(const char* aText) :
...
ZString::ZString(const signed char* aText) :
...
ZString::ZString(const unsigned char* aText) :
   iBuffer(newStringBuffer(strlen((const char*)aText)))
{
...
ZString::ZString(const void* aData, long aSize) :
...
ZString::ZString(signed char aChar) :
   iBuffer(new ZStringBuffer(1))
{
...
ZString::ZString(unsigned char aChar) :
   iBuffer(new ZStringBuffer(1))
{
...
ZString::ZString(signed short aValue)
{
...
ZString::ZString(unsigned short aValue)
{
...
ZString::ZString(unsigned aValue)
{
...
ZString::ZString(signed long aValue)
{
...
ZString::ZString(unsigned long aValue)
{
...
char& ZString::operator[](int aIndex)
{
...
char& ZString::operator[](unsigned aIndex)
{
...
char& ZString::operator[](long aIndex)
{
...
char& ZString::operator[](unsigned long aIndex)
{
...
const char& ZString::operator[](int aIndex) const
{
...
const char& ZString::operator[](unsigned aIndex) const
{
...
const char& ZString::operator[](long aIndex) const
{
...
const char& ZString::operator[](unsigned long aIndex) const
{
...
int ZString::asInt() const
{
   ZFUNCTRACE_DEVELOP("ZString::asInt() const");
   return atoi(*iBuffer);
} // asInt

long ZString::asLong() const
{
   ZFUNCTRACE_DEVELOP("ZString::asLong() const");
   return atol(*iBuffer);
} // asLong

unsigned ZString::asUnsigned() const
{
   ZFUNCTRACE_DEVELOP("ZString::asUnsigned() const");
   return strtoul(*iBuffer, 0, 10 );
} // asUnsigned

unsigned long ZString::asUnsignedLong() const
{
   ZFUNCTRACE_DEVELOP("ZString::asUnsignedLong() const");
   return strtoul(*iBuffer, 0, 10 );
} // asUnsignedLong

double ZString::asDouble() const
{
   ZFUNCTRACE_DEVELOP("ZString::asDouble() const");
   return atof(*iBuffer);
} // asDouble

long ZString::indexOf(const ZString& aString, long aStartPos, ZBoolean aIgnoreCase) const
{
...
long ZString::indexOf(char aChar, long aStartPos) const
{
...
long ZString::indexOf(signed char aChar, long aStartPos) const
{
   ZFUNCTRACE_DEVELOP("ZString::indexOf(signed char aChar, long aStartPos) const");
   return indexOf((char)aChar, aStartPos);
} // indexOf

long ZString::indexOf(unsigned char aChar, long aStartPos) const
{
   ZFUNCTRACE_DEVELOP("ZString::indexOf(unsigned char aChar, long aStartPos) const");
   return indexOf((char)aChar, aStartPos);
} // indexOf

long ZString::lastIndexOf(const ZString& aString, long aStartPos, ZBoolean aIgnoreCase) const
{
...
long ZString::lastIndexOf(char aChar, long aStartPos) const
{
...
ZString ZString::subString(long aStart, long aCount, char aPadChar) const
{
...
ZBoolean ZString::isPrintable() const
{
...
ZString& ZString::operator=(const ZString& aString)
{
...
ZString& ZString::operator=(const char* aString)
{
...
ZString ZString::operator+(const ZString& aString) const
{
...
ZString ZString::operator+(const char* aString) const
{
...
ZString ZString::operator+(char aChar) const
{
...
ZString operator+(const char* aString1, const ZString& aString2)
{
   ZFUNCTRACE_DEVELOP("operator+(const char* aString1, const ZString& aString2)");
...
ZString operator+(char aChar, const ZString& aString)
{
...
ZString& ZString::operator+=(char aChar)
{
...
ZString ZString::lowerCase(const ZString& aString)
{
...
ZString ZString::upperCase(const ZString& aString)
{
...
ZString& ZString::center(long aLength, char aPadChar)
{
...
ZString& ZString::leftJustify(long aLength, char aPadChar)
{
...
ZString& ZString::rightJustify(long aLength, char aPadChar)
{
...
ZString& ZString::strip(char aChar)
{
...
ZString& ZString::stripLeading(char aChar)
{
...
ZString& ZString::stripTrailing(char aChar)
{
...
ZString ZString::words(long aFirst, long aCount) const
{
...
ZString& ZString::removeWords(long aFirst, long aCount)
{
...
ZString ZString::removeWords(const ZString& aString, long aFirst, long aCount)
{
...
ZString ZString::imp(const ZString& aString)
{
...
ZString ZString::exp(const ZString& aString)
{
...
ZString ZString::hex(char aValue)
{
...
ZString ZString::hex(signed char aValue)
{
...
ZString ZString::hex(unsigned char aValue)
{
...
ZString ZString::hex(signed aValue)
{
...
ZString ZString::hex(unsigned aValue)
{
...
ZString ZString::hex(signed long aValue)
{
...
ZString ZString::hex(unsigned long aValue)
{
...
ZString ZString::hex(void* aPointer)
{
...
std::ostream& operator<<(std::ostream &aStream, const ZString& aString)
{
...
std::istream& operator>>(std::istream &aStream, ZString &aString)
{
...
ZString ZString::lineFrom(std::istream &aStream, char aDelim)
{
