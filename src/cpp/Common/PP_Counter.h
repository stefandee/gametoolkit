...
class CPCounter
{
   ...
   private:
      ...
      bool  mMaxReached;   //shows if the counter iteration has reached te maximal value
      bool  mMinReached;   //shows if the counter iteration has reached te maximal value
