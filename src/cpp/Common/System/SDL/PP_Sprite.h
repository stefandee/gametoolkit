...
//      CSprite(CPString filename, long cellWidth, long cellHeight);
   ...
   protected:
      ...
      CPGITexture*          mTexture;           //suprafata unde e incarcat sprite-ul
//      bool                  mInVideo;           //nefolosita

      bool    LoadFromFile(CPString filename);
      bool    CreateTexture(long width, long height); //evident
...
//INLINE SECTION
/////////////////////////////////////////////////////////////////////////////
inline CPGITexture* CSprite::GetTexture()
{
   return mTexture;
}
