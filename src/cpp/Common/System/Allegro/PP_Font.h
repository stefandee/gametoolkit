...
class CPFont
{
   ...
   public:
      ...
      virtual void PaintText(CPGISurface* _dest, int X, int Y, CPString text);
   ...
   private:
      ...
      // font reference, replace with lib/platform appropriate (HFONT, SDL_ttf* and so on)
      void* mFont;
      CPGISurface*   mRenderSurface;
};
