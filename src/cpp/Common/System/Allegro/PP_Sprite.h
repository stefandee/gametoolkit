...
//      CSprite(CPString filename, long cellWidth, long cellHeight);
   ...
   protected:
      ...
      CPGISurface*          mSurface;           //suprafata unde e incarcat sprite-ul
//      bool                  mInVideo;           //nefolosita

      bool    LoadGraphicFile16(CPString filename);
      bool    CreateSurface(long width, long height); //evident
      GLoad*  GetLoader(CPString _filename);    // a factory method to retrive a loader class based on extension
};
...
//INLINE SECTION
/////////////////////////////////////////////////////////////////////////////
inline CPGISurface* CSprite::GetSurface()
{
   return mSurface;
}
